...
RUN R -e "install.packages(c('xgboost','RcppRoll','prophet','tidyverse','plotly','lubridate','rvest','stringr','openxlsx','shinythemes','jsonlite','forecast','tidymodels','modeltime','timetk','earth','rjson','promises','future','cachem','arrow','RPostgreSQL','vroom'), repos='https://cloud.r-project.org/')"
